                ...
                return $this->items->map(function ($item) {
                    return [
                        ...
                        'offer' => [
                            ...
                            'is_expired' => $item->offer->isExpired(),
                            'is_expire' => $item->offer->isExpired(),
                            'is_not_started' => $item->offer->isNotYetStarted(),
                            'effective_status' => $item->offer->effectiveStatus(),
                        ],
            ...
            'coupons' => $this->whenLoaded('coupons', function () {
                return $this->coupons->map(function ($coupon) {
                    return [
                        ...
                        'is_expire' => $coupon->isExpired(),
                        'is_not_started' => $coupon->isNotYetStarted(),
                        'effective_status' => $coupon->effectiveStatus(),

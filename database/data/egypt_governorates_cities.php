...
/**
 * Egypt: 27 governorates and main cities (for dropdowns).
 */
...
return [
            ['name_ar' => 'القاهرة', 'name_en' => 'Cairo', 'order_index' => 1, 'cities' => [
                ...
                ['name_ar' => 'حلوان', 'name_en' => 'Helwan', 'order_index' => 11],
                ['name_ar' => 'مصر الجديدة', 'name_en' => 'Heliopolis', 'order_index' => 12],
                ['name_ar' => 'التجمع الخامس', 'name_en' => 'Fifth Settlement', 'order_index' => 13],
                ['name_ar' => 'وسط القاهرة', 'name_en' => 'Downtown Cairo', 'order_index' => 14],
                ['name_ar' => 'المطرية', 'name_en' => 'Matariya', 'order_index' => 15],
                ['name_ar' => 'الخصوص', 'name_en' => 'Khosous', 'order_index' => 16],
                ['name_ar' => '15 مايو', 'name_en' => '15th of May City', 'order_index' => 17],
                ['name_ar' => 'التبين', 'name_en' => 'Tebeen', 'order_index' => 18],
            ]],
            ['name_ar' => 'الجيزة', 'name_en' => 'Giza', 'order_index' => 2, 'cities' => [
                ...
                ['name_ar' => 'الحوامدية', 'name_en' => 'Hawamdiya', 'order_index' => 5],
                ...
                ['name_ar' => 'أوسيم', 'name_en' => 'Awsim', 'order_index' => 10],
                ['name_ar' => 'كرداسة', 'name_en' => 'Kerdasa', 'order_index' => 11],
                ['name_ar' => 'الصف', 'name_en' => 'Saf', 'order_index' => 12],
                ['name_ar' => 'أطفيح', 'name_en' => 'Atfih', 'order_index' => 13],
            ]],
            ['name_ar' => 'الإسكندرية', 'name_en' => 'Alexandria', 'order_index' => 3, 'cities' => [
                ...
                ['name_ar' => 'العجمي', 'name_en' => 'Agami', 'order_index' => 6],
                ...
                ['name_ar' => 'مينا البصل', 'name_en' => 'Mina El Basal', 'order_index' => 10],
                ['name_ar' => 'كرموز', 'name_en' => 'Karmouz', 'order_index' => 11],
                ['name_ar' => 'أبو قير', 'name_en' => 'Abu Qir', 'order_index' => 12],
                ['name_ar' => 'سيدي بشر', 'name_en' => 'Sidi Bishr', 'order_index' => 13],
                ['name_ar' => 'العامرية', 'name_en' => 'Ameriya', 'order_index' => 14],
            ]],
            ['name_ar' => 'الدقهلية', 'name_en' => 'Dakahlia', 'order_index' => 4, 'cities' => [
                ...
                ['name_ar' => 'المنزلة', 'name_en' => 'El Manzala', 'order_index' => 9],
                ['name_ar' => 'المطرية', 'name_en' => 'El Matareya', 'order_index' => 10],
                ['name_ar' => 'جمصة', 'name_en' => 'Gamasa', 'order_index' => 11],
                ['name_ar' => 'السنبلاوين', 'name_en' => 'Sinbillawain', 'order_index' => 12],
            ]],
            ['name_ar' => 'الشرقية', 'name_en' => 'Sharqia', 'order_index' => 5, 'cities' => [
                ...
                ['name_ar' => 'أبو كبير', 'name_en' => 'Abu Kabir', 'order_index' => 8],
                ['name_ar' => 'الصالحية الجديدة', 'name_en' => 'New Salhia', 'order_index' => 9],
                ['name_ar' => 'مشتهر', 'name_en' => 'Mashtoul El Souq', 'order_index' => 10],
                ['name_ar' => 'الحسينية', 'name_en' => 'Husseiniya', 'order_index' => 11],
            ]],
            ['name_ar' => 'القليوبية', 'name_en' => 'Qalyubia', 'order_index' => 6, 'cities' => [
                ...
                ['name_ar' => 'القناطر الخيرية', 'name_en' => 'Qanater Khayriyya', 'order_index' => 3],
                ...
                ['name_ar' => 'شبين القناطر', 'name_en' => 'Shibin El Qanater', 'order_index' => 7],
                ['name_ar' => 'قها', 'name_en' => 'Qaha', 'order_index' => 8],
                ['name_ar' => 'مسطرد', 'name_en' => 'Mostorod', 'order_index' => 9],
            ]],
            ['name_ar' => 'الغربية', 'name_en' => 'Gharbia', 'order_index' => 7, 'cities' => [
                ...
                ['name_ar' => 'قطور', 'name_en' => 'Qutur', 'order_index' => 7],
            ]],
            ['name_ar' => 'المنوفية', 'name_en' => 'Menoufia', 'order_index' => 8, 'cities' => [
                ...
                ['name_ar' => 'السادات', 'name_en' => 'Sadat City', 'order_index' => 6],
                ['name_ar' => 'تلا', 'name_en' => 'Tala', 'order_index' => 7],
                ['name_ar' => 'بركة السبع', 'name_en' => 'Birket El Sab', 'order_index' => 8],
            ]],
            ['name_ar' => 'البحيرة', 'name_en' => 'Beheira', 'order_index' => 9, 'cities' => [
                ...
                ['name_ar' => 'أبو المطامير', 'name_en' => 'Abu El Matamir', 'order_index' => 7],
                ['name_ar' => 'إيتاي البارود', 'name_en' => 'Itay El Baroud', 'order_index' => 8],
                ['name_ar' => 'حوش عيسى', 'name_en' => 'Housh Eissa', 'order_index' => 9],
            ]],
            ['name_ar' => 'الإسماعيلية', 'name_en' => 'Ismailia', 'order_index' => 10, 'cities' => [
                ...
                ['name_ar' => 'القصاصين', 'name_en' => 'El Qassasin', 'order_index' => 6],
            ]],
            ['name_ar' => 'بورسعيد', 'name_en' => 'Port Said', 'order_index' => 11, 'cities' => [
                ...
                ['name_ar' => 'العرب', 'name_en' => 'El Arab', 'order_index' => 3],
            ]],
            ['name_ar' => 'السويس', 'name_en' => 'Suez', 'order_index' => 12, 'cities' => [
                ...
                ['name_ar' => 'فيصل', 'name_en' => 'Faisal (Suez)', 'order_index' => 4],
            ]],
            ['name_ar' => 'الفيوم', 'name_en' => 'Fayoum', 'order_index' => 13, 'cities' => [
                ...
                ['name_ar' => 'ابشواي', 'name_en' => 'Ebshaway', 'order_index' => 6],
            ]],
            ['name_ar' => 'بني سويف', 'name_en' => 'Beni Suef', 'order_index' => 14, 'cities' => [
                ...
                ['name_ar' => 'الفشن', 'name_en' => 'El Fashn', 'order_index' => 6],
                ['name_ar' => 'سمسطا', 'name_en' => 'Samasta', 'order_index' => 7],
            ]],
            ['name_ar' => 'المنيا', 'name_en' => 'Minya', 'order_index' => 15, 'cities' => [
                ...
                ['name_ar' => 'مطاي', 'name_en' => 'Mitai', 'order_index' => 6],
                ['name_ar' => 'أبو قرقاص', 'name_en' => 'Abu Qurqas', 'order_index' => 7],
            ]],
            ['name_ar' => 'أسيوط', 'name_en' => 'Assiut', 'order_index' => 16, 'cities' => [
                ...
                ['name_ar' => 'القوصية', 'name_en' => 'El Qusiya', 'order_index' => 6],
                ['name_ar' => 'أبوتيج', 'name_en' => 'Abu Tig', 'order_index' => 7],
            ]],
            ['name_ar' => 'سوهاج', 'name_en' => 'Sohag', 'order_index' => 17, 'cities' => [
                ...
                ['name_ar' => 'طهطا', 'name_en' => 'Tahta', 'order_index' => 6],
                ['name_ar' => 'جهينة', 'name_en' => 'Juhayna', 'order_index' => 7],
            ]],
            ['name_ar' => 'قنا', 'name_en' => 'Qena', 'order_index' => 18, 'cities' => [
                ...
                ['name_ar' => 'فرشوط', 'name_en' => 'Farshout', 'order_index' => 6],
            ]],
            ['name_ar' => 'الأقصر', 'name_en' => 'Luxor', 'order_index' => 19, 'cities' => [
                ...
                ['name_ar' => 'القرنة', 'name_en' => 'El Qurna', 'order_index' => 4],
                ['name_ar' => 'أرمنت', 'name_en' => 'Armant', 'order_index' => 5],
            ]],
            ['name_ar' => 'أسوان', 'name_en' => 'Aswan', 'order_index' => 20, 'cities' => [
                ...
                ['name_ar' => 'أسوان الجديدة', 'name_en' => 'New Aswan', 'order_index' => 6],
            ]],
            ['name_ar' => 'البحر الأحمر', 'name_en' => 'Red Sea', 'order_index' => 21, 'cities' => [
                ...
                ['name_ar' => 'شلاتين', 'name_en' => 'Shalatin', 'order_index' => 6],
            ]],
            ['name_ar' => 'الوادي الجديد', 'name_en' => 'New Valley', 'order_index' => 22, 'cities' => [
                ...
                ['name_ar' => 'بلاط', 'name_en' => 'Balat', 'order_index' => 5],
            ]],
            ['name_ar' => 'مطروح', 'name_en' => 'Matrouh', 'order_index' => 23, 'cities' => [
                ...
                ['name_ar' => 'العلمين', 'name_en' => 'El Alamein', 'order_index' => 6],
                ['name_ar' => 'الضبعة', 'name_en' => 'Dabaa', 'order_index' => 7],
            ]],
            ['name_ar' => 'شمال سيناء', 'name_en' => 'North Sinai', 'order_index' => 24, 'cities' => [
                ...
                ['name_ar' => 'الحسنة', 'name_en' => 'Hasana', 'order_index' => 5],
                ['name_ar' => 'نخل', 'name_en' => 'Nakhl', 'order_index' => 6],
            ]],
            ['name_ar' => 'جنوب سيناء', 'name_en' => 'South Sinai', 'order_index' => 25, 'cities' => [
                ...
                ['name_ar' => 'أبو رديس', 'name_en' => 'Abu Redis', 'order_index' => 6],
            ]],
            ['name_ar' => 'كفر الشيخ', 'name_en' => 'Kafr El Sheikh', 'order_index' => 26, 'cities' => [
                ...
                ['name_ar' => 'مطوبس', 'name_en' => 'Motobas', 'order_index' => 6],
                ['name_ar' => 'البرلس', 'name_en' => 'El Burullus', 'order_index' => 7],
            ]],
            ['name_ar' => 'دمياط', 'name_en' => 'Damietta', 'order_index' => 27, 'cities' => [
                ...
                ['name_ar' => 'دمياط الجديدة', 'name_en' => 'New Damietta', 'order_index' => 6],
            ]],
        ];

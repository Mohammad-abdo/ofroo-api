    ...
    public function run(): void
    {
        ...
        foreach ($merchants as $merchant) {
            ...
            for ($i = 0; $i < 50; $i++) {
                ...
                $currentBalance += ($transactionFlow === 'incoming') ? $amount : -$amount;
                ...
                if ($merchantOrders->isNotEmpty() && $faker->boolean(50)) {
                    ...
                    if ($faker->boolean(30)) {
                        ...
                        if ($orderPayments->isNotEmpty()) {
                            $paymentId = $faker->randomElement($orderPayments->toArray())['id'];
                        }
                    }
                }
            ...
            // Commissions from paid orders
            $paidOrders = $merchantOrders->where('payment_status', 'paid');
            foreach ($paidOrders->take(15) as $order) {
